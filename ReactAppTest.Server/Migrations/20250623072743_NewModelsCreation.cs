    ...
    public partial class NewModelsCreation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "Products",
                newName: "IX_Products_CollectionId");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    USSize = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    EUSize = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    Bust = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Waist = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Hips = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    SortOrder = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_UserId_ProductId_SizeId",
                table: "CartItems",
                columns: new[] { "UserId", "ProductId", "SizeId" },
                unique: true);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "Products",
                newName: "IX_Products_CollectionsId");
